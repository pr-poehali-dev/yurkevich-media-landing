      ...
      <section className="bg-gradient-to-r from-slate-800 to-slate-900 text-white py-24 border-b border-slate-700">
        <div className="container mx-auto px-4 text-center">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            <div className="text-center p-6 bg-white/10 rounded-sm backdrop-blur-sm">
              <Icon
                name="TrendingUp"
                size={48}
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {team.map((member, index) => (
              ...
              >
                <CardHeader>
                  <div className="w-24 h-24 bg-gradient-to-br from-slate-700 to-slate-800 rounded-sm mx-auto mb-4 flex items-center justify-center">
          ...
          <div className="max-w-4xl mx-auto">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <div>
                ...
                <Button
                  size="lg"
                  className="bg-slate-700 hover:bg-slate-600 border border-slate-600 rounded-sm"
                >
